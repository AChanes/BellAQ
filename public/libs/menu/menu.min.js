    ...
    b.prototype = {
        ...
        calcPosition: function (b) {
            ...
            return c = a(window).width(), d = b.offset(), e = {
                top: d.top + b.outerHeight() / 2 + 14
            }, d.left > c / 2 ? (this.$el.addClass("menu--right").removeClass("menu--left"), e.right = c - d.left - b.outerWidth() / 2 - 24, e.left = "auto") : (this.$el.addClass("menu--left").removeClass("menu--right"), e.left = d.left + b.outerWidth() / 2, e.right = "auto"), e
        }
